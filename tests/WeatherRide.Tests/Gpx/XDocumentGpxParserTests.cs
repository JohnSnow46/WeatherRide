...
public class XDocumentGpxParserTests
{
    ...
    [Fact]
    public async Task ParseAsync_PointWithOutOfRangeLatitude_ThrowsGpxParsingException()
    {
        const string gpx = """
            <?xml version="1.0" encoding="UTF-8"?>
            <gpx version="1.1" xmlns="http://www.topografix.com/GPX/1/1">
    ...
    [Fact]
    public async Task ParseAsync_PointWithOutOfRangeLongitude_ThrowsGpxParsingException()
    {
        const string gpx = """
            <?xml version="1.0" encoding="UTF-8"?>
            <gpx version="1.1" xmlns="http://www.topografix.com/GPX/1/1">
              <trk>
                <trkseg>
                  <trkpt lat="52.0" lon="21.0"></trkpt>
                  <trkpt lat="52.1" lon="-200.0"></trkpt>
                </trkseg>
              </trk>
            </gpx>
            """;
